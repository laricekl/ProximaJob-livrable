...
<body>
    <div class="cv-container">
        ...
        <!-- Compétences de base -->
        @if(!empty($langues_competences) || !empty($logiciels))
            <div class="cv-skills-section">
                @if(!empty($langues_competences))
                    <div><strong>Langues :</strong> {{ $langues_competences }}</div>
                @endif
                @if(!empty($logiciels))
                    <div><strong>Logiciels :</strong> {{ $logiciels }}</div>
                @endif
            </div>
        @endif
                        ...
                        <div class="cv-item">
                            ...
                            <div class="cv-content">
                                ...
                                @if(!empty($experience['description']))
                                    <div class="cv-description">{!! nl2br(htmlspecialchars($experience['description'])) !!}</div>
                                @endif
                            </div>
                        </div>
                    @endif
        ...
        @if(!empty($competences) && count($competences) > 0)
            <div class="cv-section">
                <div class="cv-section-title">COMPÉTENCES SPÉCIFIQUES</div>
                @foreach($competences as $competence)
                    @if(!empty($competence['description']))
                        <div style="font-size: 10pt; margin-bottom: 8px; line-height: 1.3;">
