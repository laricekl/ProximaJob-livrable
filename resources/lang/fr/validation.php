...
return [
    ...
    'custom'               => [
        'offre_id.exists' => 'Cette offre n\'est plus disponible. Merci de choisir une autre offre.',
        'cv.required' => 'Veuillez joindre votre CV.',
        'cv.mimes' => 'Votre CV doit être au format PDF, DOC, DOCX ou TXT.',
        'cv.max' => 'Votre CV ne doit pas dépasser :max Ko.',
        'motivation.required' => 'Veuillez joindre votre lettre de présentation.',
        'motivation.mimes' => 'La lettre de présentation doit être au format PDF, DOC ou DOCX.',
        'motivation.max' => 'La lettre de présentation ne doit pas dépasser :max Ko.',
        'additional_docs.*.intitule.required_if' => 'Ajoutez un titre pour chaque document supplémentaire.',
        'additional_docs.*.file.mimes' => 'Les documents supplémentaires doivent être au format PDF, DOC, DOCX, JPG, JPEG ou PNG.',
        'status.in' => 'Choisissez un statut valide : en attente, accepté ou rejeté.',
        'remote_work.in' => 'Choisissez un mode de travail valide : présentiel, hybride ou télétravail.',
        'job_category.in' => 'Choisissez une catégorie de poste valide.',
        'salary_type.in' => 'Choisissez une période de salaire valide.',
        'salary_max.gte' => 'Le salaire maximum doit être supérieur ou égal au salaire minimum.',
        'endDate.after_or_equal' => 'La date de fin doit être aujourd\'hui ou une date future.',
        'start_date.in' => 'Choisissez une date de démarrage valide.',
        'start_date_other.required_if' => 'Précisez la date de démarrage souhaitée.',
        'required_experience.in' => 'Choisissez un niveau d\'expérience valide.',
        'custom_benefits.json' => 'Les avantages personnalisés doivent être transmis dans un format valide.',
        'skill_levels.*.in' => 'Choisissez un niveau de compétence valide.',
        'skill_years.*.max' => 'L\'expérience sur une compétence ne peut pas dépasser :max ans.',
        'experience_years.max' => 'L\'expérience totale ne peut pas dépasser :max ans.',
    ],
    'attributes'           => [
        'address'                  => 'adresse',
        ...
        'salary_expectation_min'   => 'prétention salariale minimale',
        'salary_min'               => 'salaire minimum',
        'salary_max'               => 'salaire maximum',
        'salary_type'              => 'période de salaire',
        'second'                   => 'seconde',
        'sector'                   => 'secteur',
        'sector_id'                => 'secteur',
        'sex'                      => 'sexe',
        ...
        'skills'                   => 'compétences',
        'skills.*'                 => 'compétence',
        'skillls'                  => 'compétences techniques',
        'skillls.*'                => 'compétence technique',
        'skill_levels'             => 'niveaux de compétence',
        'skill_levels.*'           => 'niveau de compétence',
        'skill_years'              => 'années d\'expérience par compétence',
        'skill_years.*'            => 'années d\'expérience de la compétence',
        'slug'                     => 'slug',
        ...
        'teacher'                  => 'professeur',
        'terms'                    => 'conditions',
        'additional_docs'          => 'documents supplémentaires',
        'additional_docs.*.description' => 'description du document supplémentaire',
        'additional_docs.*.file'   => 'fichier du document supplémentaire',
        'additional_docs.*.intitule' => 'titre du document supplémentaire',
        'benefits'                 => 'avantages',
        'benefits.*'               => 'avantage',
        'contractType'             => 'type de contrat',
        'custom_benefits'          => 'avantages personnalisés',
        'diplome_id'               => 'diplôme',
        'diplomes'                 => 'diplômes demandés',
        'diplomes.*.id'            => 'diplôme demandé',
        'diplomes.*.obligatoire'   => 'caractère obligatoire du diplôme',
        'education_level'          => 'niveau d\'études',
        'experience_years'         => 'années d\'expérience',
        'job_category'             => 'catégorie du poste',
        'jobDescription'           => 'description du poste',
        'jobTitle'                 => 'titre du poste',
        'languages_data'           => 'langues demandées',
        'location'                 => 'lieu du poste',
        'methodological_skills'    => 'compétences méthodologiques',
        'methodological_skills.*'  => 'compétence méthodologique',
        'motivation'               => 'lettre de présentation',
        'num_skills'               => 'compétences numériques',
        'num_skills.*'             => 'compétence numérique',
        'offre_id'                 => 'offre',
        'otherCriteria'            => 'autres critères',
        'profile_photo'            => 'photo de profil',
        'remote_work'              => 'mode de travail',
        'required_experience'      => 'expérience demandée',
        'responsibilities'         => 'responsabilités',
        'start_date'               => 'date de démarrage',
        'start_date_other'         => 'date de démarrage personnalisée',
